...
**BIND**, the Open Source software that _was_ powering up DNS in almost every operating system[^3], usually contacts all root nameservers and then chooses the one with least roundtrip time. [source](https://superuser.com/questions/527116/how-does-my-browser-locate-the-nearest-dns-root-servers).
...
_I want to thank [Stéphane Bortzmeyer](https://twitter.com/bortzmeyer) for suggesting some corrections to this article._
