...
Per dare una definizione: siete *Agile*® se la vostra metodologia di sviluppo segue il [_Manifesto Agile_](http://agilemanifesto.org/iso/it/manifesto.html).
...
Ritorniamo sulle definizioni. _Lean_ (in italiano: magro, scarno) è un termine preso in prestito dal settore manifatturiero, e consiste in una serie di principi da seguire per ottenere _qualità, velocità & soddisfazione del cliente_. (Stesse finalità di Agile!)

Il punto è che i principi base del _Lean thinking_ non sono filosofici, ma pratici. Vediamoli:
...
Se dovessi scegliere un unico punto da implementare, tra tutti i punti di questo articolo, il meeting giornaliero è sicuramente quello che sceglierei io. _La comunicazione tra membri del team è dannatamente importante._
